...
<%
    String mineShopCode = (String) request.getAttribute("mineShopCode");//用request得到
%>
                ...
                <div class="list">
                    ...
                    <div class="one show">
                        <ul class="car_list font_1 color_2">
                            ...
                            <li>
                                <label>发动机号码：</label>
                                <input type="text" name="engine_number" id="engine_number" value=""
                                       style="width: 65%;"/>
                            </li>
                            <!--车架号-->
                            <!--<li>
                            ...
                            <li style="position: relative;">
                                ...
                                <input type="text" name="insurance_maturity_date" class="insurance_maturity_date"
                                       id="insurance_maturity_date" value="" style="width: 60%;"/>
                            ...
                            <li style="position: relative;">
                                <label>注册日期：</label>
                                <input type="text" name="registration_date" class="registration_date"
                                       id="registration_date" value=""/>
                                <label for="registration_date"><img src="/files/baoxian/img/calendar.png"
                                                                    style="position: absolute;top:13px;right: 44px;"
                                                                    class="calendar"/></label>
                            </li>
                            <!--使用性质-->
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="picture">
                                    ...
                                    <p class="font_5 color_6" style="width: 100%;text-align: center;margin-top: 57px;">
                                        （支持jpg格式，最大限制5M）</p>
                                </div>
                                <div class="picture">
