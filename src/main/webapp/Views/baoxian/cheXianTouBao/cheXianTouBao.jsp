				...
				<div class="nav color_1">
					...
					<div class="nav_right font_1">
						...
						<select name="unionHeadquarters">  <!--联盟总部-->
							<option value="">大师全国运营中心</option>
							<option value="">牧宝车居</option>
							<option value="">易路邦</option>
							<option value="">上海追得</option>
						</select>
					</div>
				</div>  <!--导航结束-->
				<!--主要内容-->
			       	 	...
			       	 	<div class="list">
			       	 		...
			       	 		<div class="one show">
			       	 			<ul class="car_list font_1 color_2">
			       	 				...
			       	 				<li>
			       	 					...
			       	 					<input type="radio" name="sex" value="女" class="margin_left1"/>女
			       	 				</li>
			       	 				<!--手机号码-->
			       	 				<li>
			       	 		...
			       	 		<div class="two">
			       	 			...
			       	 			<ul>
			       	 				...
			       	 				<!--车上人员责任险(乘客)-->
			       	 				<li>
			       	 					<input type="checkbox" name="chexian" id="" value="" checked="checked" class="chexian"/><span class="font_1 color_4">车上人员责任险（乘客）</span><br>
			       	 					<div class="font_5 color_2" style="margin-bottom: 32px;">
			       	 						<label for="">不计免赔：</label>
			       	 				...
			       	 				<!-- 新增设备损失险-->
			       	 				<li>
			       	 					<input type="checkbox" name="chexian" id="" value="" class="chexian"/><span class="font_1 color_4">新增设备损失险</span><br>
			       	 					<div class="font_5 color_2" style="margin-bottom: 50px;">
			       	 						<label for="">不计免赔：</label>
				       	 					<input type="radio" name="equipment_1" value="是"class="fou"/>是
				       	 					<input type="radio" name="equipment_1" value="否" />否
			       	 					</div>
			       	 					<span class="xian"></span>
			       	 				</li>
			       	 				<!--车上货物责任险-->
			       	 				<li>
			       	 					<input type="checkbox" name="chexian" id="" value="" class="chexian"/><span class="font_1 color_4">车上货物责任险</span><br>
			       	 					<div class="font_5 color_2" style="margin-bottom: 32px;">
			       	 						<label for="">不计免赔：</label>
				       	 					<input type="radio" name="goods_1" value="是"class="fou"/>是
				       	 					<input type="radio" name="goods_1" value="否" />否
				       	 					<label for="" style="margin-left: 84px;">赔偿限额：</label>
				       	 					<select name="goods">
				       	 						<option value="1万" selected="selected">1万</option>
				       	 						<option value="2万">2万</option>
			       	 				...
			       	 				<!--精神损害抚慰金责任险-->
			       	 				<li>
			       	 					<input type="checkbox" name="chexian" id="" value="" class="chexian"/><span class="font_1 color_4">精神损害抚慰金责任险</span><br>
			       	 					<div class="font_5 color_2" style="margin-bottom: 32px;">
			       	 						<label for="">不计免赔：</label>
				       	 					<input type="radio" name="spiritual_loss_1" value="是"class="fou"/>是
				       	 					<input type="radio" name="spiritual_loss_1" value="否" />否
				       	 					<label for="" style="margin-left: 84px;">赔偿限额：</label>
				       	 					<select name="spiritual_loss" disabled="disabled">
				       	 						<option value="1万" selected="selected">1万</option>
				       	 						<option value="2万">2万</option>
				       	 						<option value="5万">3万</option>
				       	 						<option value="10万">4万</option>
				       	 						<option value="20万">5万</option>
				       	 					</select>
			       	 					</div>
			       	 					<span class="xian"></span>
			       	 				</li>
