...
<html>
	<head>
		...
		<script src="/scripts/shoplogin/js/shoplogin.js" type="text/javascript" charset="utf-8"></script>
	</head>
	<body>
	<%--网页加载效果--%>
	<div id="loading">
	...
	<input name="shopcode" type="hidden" value="<%=shopcode%>">
		...
		<div class="tcc">
			...
			<div class="b_box">
				<%--<img src="/files/login/img/login/error.png" class="close"/>--%>
				<span class="l_tt font_3">网络错误</span>
				<span class="l_tj font_3">请重新登录</span>
			...
			<div class="ty">
				<%--<img src="/files/login/img/login/error.png" class="close"/>--%>
				<span class="l_tt font_3">用户名或密码输入错误</span>
