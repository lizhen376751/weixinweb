...
<body>
     ...
     <div class="zhezhao" style="text-align: initial;">		
		...
		<ul class="zhisUl" style="margin:20% 0 0 35%">
			<li id="lingqimg"><img  src="/files/shopyouhuiquan/lingqu.png"/></li>
			<li class="font_2" style="margin-left: 11%;">领取步骤</li>
			<li class="font_6">1.长按图中二维码</li>
			<li class="font_6">2.识别图中二维码</li>
			<li class="font_6">3.点击关注</li>
			<li class="font_6">
