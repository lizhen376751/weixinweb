	...
	<head>
	   ...
	   function xianshi (arr) {
					...
					if(data.length>0){
						...
						for(var i=0;i<data.length;i++){
							...
							+"<img class='AHI_biao' src='../img/biazhi.png'/>"
						  	...
						  	+"<a href='#' onclick=toSubxiangqing('"+data[i].id+"','"+data[i].plateNumber+"')><span class='miaos font_1'>&nbsp;<img src='../img/miaos.png'/></span></a>"
						  	+"</li>");
						}
					}
				}
		...
		function toSubxiangqing(id,plateNumber){
			...
			window.location.href='subxiangqing.jsp?plateNumber='+encodeURI(encodeURI(plateNumber))+'&id='+id;
		}
