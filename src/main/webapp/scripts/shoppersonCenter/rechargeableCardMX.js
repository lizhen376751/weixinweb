...
$(document).ready(function () {
    ...
    function appending (arr) {
        ...
        for (var i = 0;i < arr.length;i++) {
            ...
            var li = $("ul li");//消费详情
            var s = i + 1;
            obj_append("div3","width_2 shenglue",$(li[s]),"span",arr[i].cardNumb);
            obj_append("div5","width_2 margin_2 shenglue",$(li[s]),"span",dateFormat(arr[i].transactionTime));
            obj_append("div6","width_1 margin_2 shenglue",$(li[s]),"span",arr[i].transactionAmount);
        }
    }
